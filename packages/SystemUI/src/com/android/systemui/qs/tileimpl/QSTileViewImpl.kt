...
constructor(
    ...
    private fun createAndAddLabels() {
        labelContainer =
            LayoutInflater.from(context).inflate(if (vertical) R.layout.qs_tile_label_vertical else R.layout.qs_tile_label, this, false)
    ...
    private fun loadSideViewDrawableIfNecessary(state: QSTile.State) {
        ...
        } else if ((state !is AdapterState || state.forceExpandIcon) && !vertical && !labelHide) {
