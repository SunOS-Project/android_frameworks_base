...
public class RecordingService extends Service implements ScreenMediaRecorderListener {
    ...
    public RecordingService(RecordingController controller, @LongRunning Executor executor,
            ...
            FeatureFlags featureFlags, DialogTransitionAnimator dialogTransitionAnimator,
    ...
    public static Intent getStartIntent(Context context, int resultCode,
            ...
            boolean showStopDot, boolean lowQuality, boolean hevc) {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        switch (action) {
            ...
            case ACTION_SHOW_DIALOG:
                if (mController != null) {
                    mController.createScreenRecordDialog(this, mFeatureFlags,
                            mDialogTransitionAnimator, mActivityStarter, null).show();
                }
                break;
        }
    ...
    private static Intent getDeleteIntent(Context context, Uri path, int id) {
