...
class FaceAuthenticationClient
    ...
    public boolean wasUserDetected() {
        ...
        return mLastAcquire != BiometricFaceConstants.FACE_ACQUIRED_NOT_DETECTED
                && mLastAcquire != BiometricFaceConstants.FACE_ACQUIRED_SENSOR_DIRTY;
    }
    ...
    private boolean shouldSend(int acquireInfo, int vendorCode) {
        if (acquireInfo == BiometricFaceConstants.FACE_ACQUIRED_VENDOR) {
    ...
    public void onAcquired(int acquireInfo, int vendorCode) {
        ...
        if (acquireInfo == BiometricFaceConstants.FACE_ACQUIRED_RECALIBRATE) {
