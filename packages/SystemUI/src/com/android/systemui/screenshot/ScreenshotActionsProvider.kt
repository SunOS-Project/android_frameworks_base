    ...
    init {
        ...
        actionsCallback.provideActionButton(
            ActionButtonAppearance(
                ...
                context.resources.getString(com.android.internal.R.string.delete),
                context.resources.getString(com.android.internal.R.string.delete),
            ),
            showDuringEntrance = true,
        ) {
        ...
        actionsCallback.provideActionButton(
            ActionButtonAppearance(
                AppCompatResources.getDrawable(context, R.drawable.ic_screenshot_google_lens),
                context.resources.getString(R.string.google_lens),
                context.resources.getString(R.string.google_lens),
            ),
            showDuringEntrance = true,
        ) {
