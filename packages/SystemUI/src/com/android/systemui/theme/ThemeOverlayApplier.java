...
public class ThemeOverlayApplier implements Dumpable {
    ...
    static final String OVERLAY_PURE_BLACK_THEME = "com.android.system.theme.black";
    ...
    public void checkDarkUserOverlays(
        ...
        OverlayManagerTransaction.Builder transaction = getTransactionBuilder();
        try {
            transaction.setEnabled(getOverlayID(OVERLAY_PURE_BLACK_THEME), blackMode, currentUser);
